...
<div id="enterprise">
  <div class="hrm_module">
    <el-row :gutter="20" class="padding_top_20 hrm_module_con">
      <el-col :span="6"><ul class="talentpool_head_ul" @click="changetalentStatus(0)" :class="{'active':talentStatus==0}"><li>全部</li><li class="font_size_20">{{count.allCount}}</li></ul></el-col>
      <el-col :span="6"><ul class="talentpool_head_ul" @click="changetalentStatus(1)" :class="{'active':talentStatus==1}"><li>淘汰库</li><li class="font_size_20">{{count.eliminateCount}}</li></ul></el-col>
      <el-col :span="6"><ul class="talentpool_head_ul" @click="changetalentStatus(2)" :class="{'active':talentStatus==2}"><li>储备库</li><li class="font_size_20">{{count.talentCount}}</li></ul></el-col>
      <el-col :span="6"><ul class="talentpool_head_ul" @click="changetalentStatus(3)" :class="{'active':talentStatus==3}"><li>未入职</li><li class="font_size_20">{{count.unEnterCount}}</li></ul></el-col>
...
export default {
  ...
  data(){
    return{
      ...
      input2:'',
      wherecome: this.$route.query.type || -1,
      options:[
        {value: '0',label: '应届'},
        {value: '1',label: '一年'},
        {value: '2',label: '两年'},
